    ...
    <div className="w-full max-w-3xl mx-auto mt-2 mb-8 relative z-10">
      ...
      >
        <div className="flex items-center gap-3 mb-3">
          ...
          <span className="px-1.5 py-0.5 rounded-full bg-[#18151d] text-[9px] font-mono text-white/30 border border-white/5">03</span>
        </div>
          ...
          {[
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-mono text-white/20 group-hover:text-white/50 transition-colors uppercase tracking-tight">{source.site}</span>
              </div>
            </a>
          ))}
        </div>
